...
class HiddenElements():
    ...
    def testExpedia(self):
        ...
        elements=driver.find_elements_by_css_selector("span[class ='tab-label']")
        elements.get(0).click()
        time.sleep(2)
        driver.find_element_by_css_selector("li[class='open']>button").click()
        #driver.find_element_by_id("tab-flight-tab").click()

        drpdwnElement = driver.find_element_by_css_selector("div[class^='traveler-selector-sinlge-room-data'][css='1']")
